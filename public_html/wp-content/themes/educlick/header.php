...
<?php
$tagline = get_field('tagline', 99999);
$button = get_field( 'button', 99999 );
$button_url = get_field( 'button_url', 99999 );

$button_booking = get_field( 'button_booking', 99999 );
$button_booking_url = get_field( 'button_booking_url', 99999 );
?>
	<header class="Header container-fluid">
      <div class="row d-flex justify-content-between align-items-center">
  
      <a href="<?php echo $button_booking_url; ?>" class="col-sm-2 col-6 Button" target="_blank"><?php echo $button_booking; ?></a>

        <div class="col-sm-8 d-none d-sm-block Tagline">
      <!-- <a href="<?php echo get_home_url(); ?>" class="Logo">
        ...
        <a href="<?php echo $button_url; ?>" class="col-sm-2 col-6 Button" target="_blank"><?php echo $button; ?></a>
